...
export const locations: Location[] = [
  {
    ...
    intro: 'Philadelphia parking conditions change block by block. A useful valet plan accounts for the actual curb, the storage route, pedestrian movement, loading activity, and the time guests will arrive, not just the venue address.',
  ...
  },
  {
    ...
    intro: 'Center City leaves little room for guesswork. Loading zones, bike lanes, crosswalks, deliveries, buses, and rideshare traffic can all touch the same entrance. The operating plan starts by assigning each movement a clear place and time.',
  ...
  },
  {
    ...
    intro: 'Main Line properties often have more land than a Center City venue, but arrivals can still bottleneck at narrow drives, residential roads, and single-lane entrances. We plan the guest handoff and the vehicle route as separate movements.',
  ...
  },
  {
    ...
    intro: 'King of Prussia sites can involve large lots, garages, divided roads, multiple entrances, and overlapping hotel, restaurant, retail, and office traffic. A clear post plan keeps guests from circling and preserves the main entrance.',
  ...
  },
  {
    ...
    intro: 'Bucks County events often pair scenic properties with narrow approaches, unpaved overflow, low evening light, or parking that sits far from the guest entrance. The plan connects those details to staffing and retrieval time.',
  ...
  },
  {
    ...
    intro: 'South Jersey service planning can range from a compact downtown restaurant to a large wedding property with remote parking. We review the entrance, cross-traffic, vehicle storage, and late-night retrieval route before setting the crew plan.',
